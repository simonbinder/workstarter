...
public class MailService {
	...
	private static final String COMPANYADMIN = "companyadmin";
	...
	@Async
	public void sendApplicationEmail(CompanyAdmin companyAdmin, Student user, Jobadvertisment job, String message) {
		Locale locale = Locale.forLanguageTag(companyAdmin.getLangKey());
		Context context = new Context(locale);
		context.setVariable(USER, user);
		context.setVariable(COMPANYADMIN, companyAdmin);
		context.setVariable(MESSAGE, message);
		context.setVariable(JOB, job);
		context.setVariable(BASE_URL, jHipsterProperties.getMail().getBaseUrl());
		String content = templateEngine.process("applicationEmail", context);
		String subject = messageSource.getMessage("email.application.title", null, locale);
		sendEmail(companyAdmin.getEmail(), subject, content, false, true);
	}
