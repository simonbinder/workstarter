...
public class AccountResourceIntTest {
	...
	@Mock
	private StudentService mockUserService;
	...
	public void testRegisterValid() throws Exception {
		...
		Optional<Student> user = userRepository.findOneByLogin("joe");
	...
	public void testRegisterInvalidLogin() throws Exception {
		...
		Optional<Student> user = userRepository.findOneByEmail("funky@example.com");
	...
	public void testRegisterInvalidEmail() throws Exception {
		...
		Optional<Student> user = userRepository.findOneByLogin("bob");
		assertThat(user.isPresent()).isFalse();
	}
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<Student> userDup = userRepository.findOneByEmail("alicejr@example.com");
	...
	public void testRegisterDuplicateEmail() throws Exception {
		...
		Optional<Student> userDup = userRepository.findOneByLogin("johnjr");
		assertThat(userDup.isPresent()).isFalse();
	}
	...
	public void testRegisterAdminIsIgnored() throws Exception {
		...
		Optional<Student> userDup = userRepository.findOneByLogin("badguy");
	...
	public void testSaveInvalidLogin() throws Exception {
		StudentDTO invalidUser = new StudentDTO(null, // id
				"funky-log!n", // login <-- invalid
				"Funky", // firstName
				"One", // lastName
				"funky@example.com", // e-mail
